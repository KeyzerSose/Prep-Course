...
function esPrimo(numero) {
  ...
  var b=0
  var a
  for(i=1;i<= numero;i++){ a=numero%i 
  if(a==0){b=b+1 }} 
    if(i==numero || b==2) {return true} 
      else if(i==numero || b>2) { return false}
      else if(i==numero || b<2){return false}
}
...
function esVerdadero(valor){
  ...
  else if (a== false){return 'Soy falso'}
}
...
function tieneTresDigitos(numero){
  ...
  //Escribe tu código aquí
  var longnum = (''+numero).length
  if (longnum==3) {return true}
  else return false
